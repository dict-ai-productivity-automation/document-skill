...
Skill (SKILL.md) guides AI to write structured Markdown
       ↓
python generate.py converts Markdown → DOCX
       ↓
...
- `skill/docs/parser.py` — Markdown/ YAML frontmatter parser
- `skill/docs/builder.py` — DOCX document builder (styles, sections, tables, etc.)
- `skill/docs/styles.py` — Academic style presets (fonts, spacing, margins)
- `skill/docs/requirements.txt` — Dependencies (`python-docx`, `pyyaml`, `markdown`)
