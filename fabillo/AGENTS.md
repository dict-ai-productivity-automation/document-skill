...
- Use the `docx` skill to build the document using python-docx.
...
2. Consult the `docx` skill for the correct python-docx API usage.
3. Write a Python script that builds the document.
